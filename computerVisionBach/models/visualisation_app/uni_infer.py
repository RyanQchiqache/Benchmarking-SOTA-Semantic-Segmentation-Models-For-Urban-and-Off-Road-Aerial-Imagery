...
# Your SMP import
from models.model_pipeline import smp
...
# ---------- Model factories ----------
def _build_smp_unet(num_classes: int, in_channels: int, encoder_name: str):
    return smp.Unet(encoder_name=encoder_name, encoder_weights="imagenet",
                    in_channels=in_channels, classes=num_classes)

def _build_smp_deeplab(num_classes: int, in_channels: int, encoder_name: str):
